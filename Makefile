...
$(RELEASE_BINARY): $(RELEASE_APP_OBJECT) $(RELEASE_LIBRARY)
	@mkdir -p $(dir $@)
	$(CC) $(LDFLAGS) $(RELEASE_LINK_FLAGS) $(RELEASE_APP_OBJECT) \
...
$(RELEASE_LEDUC_BINARY): $(RELEASE_LEDUC_APP_OBJECT) $(RELEASE_LIBRARY)
	@mkdir -p $(dir $@)
	$(CC) $(LDFLAGS) $(RELEASE_LINK_FLAGS) $(RELEASE_LEDUC_APP_OBJECT) \
		$(RELEASE_LIBRARY) \
		$(LDLIBS) -o $@
...
$(RELEASE_BLACKJACK_BINARY): $(RELEASE_BLACKJACK_APP_OBJECT) $(RELEASE_LIBRARY)
	@mkdir -p $(dir $@)
	$(CC) $(LDFLAGS) $(RELEASE_LINK_FLAGS) $(RELEASE_BLACKJACK_APP_OBJECT) \
		$(RELEASE_LIBRARY) \
		$(LDLIBS) -o $@
...
$(RELEASE_BLACKJACK_COMPACT_EVAL_BINARY): \
	...
	@mkdir -p $(dir $@)
	$(CC) $(LDFLAGS) $(RELEASE_LINK_FLAGS) $(RELEASE_BLACKJACK_COMPACT_EVAL_OBJECT) \
		$(RELEASE_LIBRARY) $(LDLIBS) -o $@

$(RELEASE_POKER_TREE_EXPORT_BINARY): $(RELEASE_POKER_TREE_EXPORT_OBJECT) \
		$(RELEASE_LIBRARY)
	@mkdir -p $(dir $@)
	$(CC) $(LDFLAGS) $(RELEASE_LINK_FLAGS) $(RELEASE_POKER_TREE_EXPORT_OBJECT) \
		$(RELEASE_LIBRARY) $(LDLIBS) -o $@
...
$(TRAINING_BENCHMARK_BINARY): $(TRAINING_BENCHMARK_OBJECT) $(RELEASE_LIBRARY)
	@mkdir -p $(dir $@)
	$(CC) $(LDFLAGS) $(RELEASE_LINK_FLAGS) $(TRAINING_BENCHMARK_OBJECT) \
		$(RELEASE_LIBRARY) $(LDLIBS) -o $@

$(EVALUATION_BENCHMARK_BINARY): $(EVALUATION_BENCHMARK_OBJECT) \
		$(RELEASE_LIBRARY)
	@mkdir -p $(dir $@)
	$(CC) $(LDFLAGS) $(RELEASE_LINK_FLAGS) $(EVALUATION_BENCHMARK_OBJECT) \
		$(RELEASE_LIBRARY) $(LDLIBS) -o $@

$(CHECKPOINT_BENCHMARK_BINARY): $(CHECKPOINT_BENCHMARK_OBJECT) \
		$(RELEASE_LIBRARY)
	@mkdir -p $(dir $@)
	$(CC) $(LDFLAGS) $(RELEASE_LINK_FLAGS) $(CHECKPOINT_BENCHMARK_OBJECT) \
		$(RELEASE_LIBRARY) $(LDLIBS) -o $@
